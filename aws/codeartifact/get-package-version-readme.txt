...
OPTIONS
       ...
       --namespace (string)
          ...
          NOTE:
              The namespace is required when requesting the readme from  pack-
              age versions of the following formats:
          ...
          o Python,  NuGet,  and Ruby package versions do not contain a corre-
            sponding component, package versions of those formats do not  have
            a namespace.
